"""Global (whole-tomogram) input normalization, shared by extraction and inference so
both measure the statistic the same way. center = mean; scale = MAD*1.4826 (global_mad,
default) or std (global_std, legacy)."""
import numpy as np

NORM_GLOBAL_MAD = "global_mad"
NORM_GLOBAL_STD = "global_std"
